...
pm2 stop damned-designs-backend damned-designs-storefront damned-designs-admin damned-designs-images
if [ $? -ne 0 ]; then
...
pm2 restart damned-designs-backend damned-designs-storefront damned-designs-admin damned-designs-images
if [ $? -ne 0 ]; then
