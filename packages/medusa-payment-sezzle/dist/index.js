...
var _sezzleProvider = _interopRequireDefault(require("./services/sezzle-provider"));
...
var _default = exports["default"] = {
  load: function load(container, options) {
    ...
    container.registerService({
      sezzleProvider: function sezzleProvider(container) {
        return new _sezzleProvider["default"]({}, options);
      }
    });
  ...
  service: _sezzleProvider["default"]
};