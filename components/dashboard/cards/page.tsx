...
const Cards: React.FC<CardsProps> = (props) => {
  ...
  const handleScrollValue = (flag: Boolean) => {
    if(flag) {
  ...
  return (
    <div className={`${props.className} px-4 sm:px-4 md:px-20 lg:px-40`}>
      <p className="text-xl md:text-3xl">A PROVEN TRACK RECORD!</p>
      <div className="my-1 md:my-4 flex justify-between">
        <div className="flex">
      ...
      <div className="relative flex flex-col bg-white">
        <button className="absolute left-0 bottom-20 opacity-75 bg-slate-200 rounded-full z-10" onClick={()=>handleScrollValue(false)}>
          <svg
        ...
        <button className="absolute right-0 bottom-20 opacity-75 bg-slate-200 rounded-full z-10" onClick={()=>handleScrollValue(true)}>
          <svg
            className="h-10 w-10 text-green-700"
            viewBox="0 0 24 24"
            strokeWidth="2"
        ...
        <div className="relative flex overflow-x-scroll pb-10 hide-scroll-bar" ref={scrollRef}>
          <div className="flex flex-nowrap lg:ml-40 md:ml-20 ml-10 ">
            <div className="inline-block px-3">
              <div className="lg:w-[30vw] w-96 overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                <Card
                  name="Gray"
