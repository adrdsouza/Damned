interface WhatForProps {
  className?: string;
}

const WhatFor = (props: WhatForProps) => {
  return (
        ...
        <div>
          ...
          >
            <div className="flex">
              ...
              <div className="ml-3 w-full">MySelf</div>
            </div>
          </label>
        </div>
        <div>
          ...
          >
            <div className="flex">
              ...
              <div className="ml-3 w-full">My Family and I</div>
            </div>
          </label>
        </div>
        <div>
          ...
          >
            <div className="flex">
              ...
              <div className="ml-3 w-full">A Group</div>
            </div>
          </label>
        </div>
      </div>
