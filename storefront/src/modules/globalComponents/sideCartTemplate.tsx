    ...
    <>
      ...
      {showCart && (
        ...
        <div className="fixed top-1/2 right-0 transform -translate-y-1/2 w-[800px] max-w-[90vw] ">
          {/* <ul className="flex flex-col p-4 space-y-2 border-b border-gray-200">
          ...
          {cart?.items?.length ?   <div className='flex flex-col md:flex-row h-full'>
         
            <div className="w-full md:w-2/5 bg-gray-50 p-4 overflow-y-auto flex flex-col h-full
" data-testid="cart-container">
            ...
            <div className="w-full md:w-3/5 p-4 overflow-y-auto h-full">
      ...
      {/* {
        showCheckout &&
        <div className='fixed right-0 top-[0px] h-[100%] overflow-y-scroll scroll-custom
 w-[400px] bg-white shadow-lg border rounded-md z-50'>
          <ul className="flex flex-col p-4 space-y-2 border-b border-gray-200">
            <li className="block font-medium text-xl py-2 text-black hover:text-gray-600 transition-colors flex justify-between">
              <div className='text-center'>
          ...
          <div className="grid grid-cols-1 content-container gap-x-40 py-12">
            <PaymentWrapper cart={cart}>
              <CheckoutForm cart={cart} customer={customer} />
            </PaymentWrapper>
            <CheckoutSummary cart={cart} />
