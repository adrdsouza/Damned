...
async function getRegionMap(cacheId: string) {
  ...
  if (
    ...
    if (!regions.length) {
      console.error("No regions found. Using fallback US region.");
      regions = [
        {
          id: "reg_us",
          name: "United States",
 ...
 * @param request
 * @param regionMap
 * @returns countryCode string or DEFAULT_REGION as fallback
 */
...
export async function middleware(request: NextRequest) {
  ...
  // Fallback - should not reach here in most cases
  return NextResponse.next()
}
