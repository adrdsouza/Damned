    ...
    <div className='flex flex-col gap-[3em] w-full px-[30px] py-[2em] md:py-[4em] 2xl:w-[1440px] m-auto'>
      ...
      <div className='text-md flex flex-col gap-3'>
        ...
        <p>
          ...
          European regulation) and the California Online Privacy Protection Act
          (CalOPPA – U.S regulation).
        </p>
      </div>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <a
          ...
          className='list-item underline list-inside '
        >
          https://damneddesigns.com
        </a>
        <p>Will be under responsibility and in charge of:</p>
        <li>Damned Venttures LLC - Damned Desgins</li>
        <li>Adrian Dsouza. Info@damneddesigns.com. +1 3376029228</li>
        <p>(Hereinafter referred to as “Damned Designs”).</p>
      </div>

      <div className=' flex flex-col gap-3'>
        <p className='font-bold'>2. TYPES OF INFORMATION GATHERED</p>
        <p>
        ...
        <p>
          Information You Give Us. You provide information when you search, read
          and view content, purchase products and/or communicate with us through
          our contact information or through our contact forms. As a result of
          those actions, you might supply us with the following information:
        </p>
        ...
        <ul className='list-disc flex flex-col gap-3 list-inside'>
          ...
          <li>
            <a
              href='https://legal.sezzle.com/privacy'
              target='_blank'
              rel='noopener'
            >
        ...
        <p>
          ...
          not personally identifiable when your web browser accesses, Damned
          Designs or third-party content served by or on behalf of Damned
          Designs on other websites. Some of the information we collect and
          analyze includes the Internet protocol (IP) address; computer and
          connection information such as browser type, version, and connection
          speed; purchase history; and the products you searched for, viewed,
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>3. HOW LONG WE KEEP YOUR DATA</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>4. HOW WE USE YOUR INFORMATION.</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>5. HOW DO YOU GET MY CONSENT?</p>
        <p>
          ...
          information on the terms contained in this privacy policy.&nbsp; You
          consent to the use of cookies on our website when you give your
          acceptance through the pop-up window shown on the home page when you
          enter the website. You may withdraw your consent by sending us your
          request via the contact information or the contact page.
        </p>
      </div>

      <div className='flex flex-col gap-3'>
        <p className='font-bold'>6. HOW WE SHARE INFORMATION</p>
        <p>
        ...
        <p>
          <strong>Third-Party Service Providers.</strong>&nbsp;We use the
          services of third parties to perform certain functions on our behalf
          and through our website and services. Examples include processing
          payments (PayPal, Sezzle), building and hosting the website,
          delivering products (shipping companies), sending emails, analyzing
          data (Google Analytics), creating ads (Facebook, Google), providing
          marketing assistance, and delivering search results and links.
        </p>
        <p>
        ...
        <p>
          <strong>Business Transfers</strong>.&nbsp;In the event that Damned
          Designs creates, merges with, or is acquired by another entity, your
        ...
        <p>
          ...
          <strong>and others</strong>.&nbsp;We release personal information when
          we believe release is appropriate to comply with the law, enforce or
        ...
        <p>
          ...
          you will receive notice when personally identifiable information about
        ...
        <p>
          <strong>Email Address</strong>.&nbsp;The email address that you supply
          to us for purposes of receiving our email communications will never be
          rented or sold to a third party.
        </p>
      </div>

      <div className='flex flex-col gap-3'>
        <p className='font-bold'>7. PROTECTING YOUR INFORMATION</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>8. RIGHTS</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>9. CHILDREN’S ONLINE PRIVACY PROTECTION</p>
        <p>
          We are in compliance with the requirements of the GDPR (General Data
          Protection Regulation – European regulation) and the California Online
          Privacy Protection Act (CalOPPA – U.S regulation), regarding the
          protection of the personal data of minors. Although the website and
          products are available to all ages, we do not collect any information
          from children under the age of 13 without the respective permission of
          their parents or legal guardians. If you become aware that a child
          under the age of 13 has provided us with personal information without
          the permission of a parent or legal guardian, please contact us. If we
          become aware that a minor has provided us with personal information
          without parental or legal guardian permission, we will take steps to
          delete that information, terminate that person’s account, and restrict
          access to that person’s account.
        </p>
      </div>

      <div className='flex flex-col gap-3'>
        <p className='font-bold'>10. EDITING AND DELETING INFORMATION</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>11. THIRD PARTIES</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <p>
          <strong>Adrian Dsouza. Info@damneddesigns.com. +1 3376029228</strong>
        </p>
      </div>
    </div>
  );
