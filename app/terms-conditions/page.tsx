    ...
    <div className='flex flex-col gap-[3em] w-full px-[30px] py-[2em] md:py-[4em] 2xl:w-[1440px] m-auto'>
      ...
      <div className='text-md flex flex-col gap-3'>
        ...
        <ul className='list-disc flex flex-col gap-3 list-inside'>
          <li>
            <a href='https://damneddesigns.com'>https://damneddesigns.com</a>
          </li>
        </ul>
        ...
        <p>
          ...
          referred to as “Products”) from such website, means that you agree to
          these terms and conditions as set out below (hereinafter referred to
          as “Terms”).
        </p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>1. ELIGIBLITY</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>2. ACCOUNT</p>
        <p>
        ...
        <p>
          ...
          contact information or by using the “unsubscribe” option in emails or
          mobile notifications. Opting out may prevent you from receiving emails
          about updates, news or special offers on our products.
        </p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>3. SHOPPING ON THE WEBSITE</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>4. PRICES</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>5. PAYMENTS</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>6. PRODUCT DESCRIPTIONS</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>7. DISCLAIMER</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>8. COPYRIGHT</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>9. COPYRIGHT COMPLAINTS (DMCA)</p>
        <p>
          ...
          and expects users to do the same.&nbsp; If you believe, in good faith,
          that any material provided on or in connection with the Damned Designs
        ...
        <ul className='list-disc flex flex-col gap-3 list-inside'>
          ...
          <li>
            ...
            Damned Designs &nbsp;Please note: it is not sufficient to merely
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>10. PROHIBITED ACTIVITIES</p>
        <p>
        ...
        <ul className='list-disc flex flex-col gap-3 list-inside'>
          ...
          <li>
            ...
            into any other website or service without our prior written
            permission;
          </li>
          <li>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>13. ELECTRONIC COMMUNICATIONS</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>14. CHANGES AND TERMINATION</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>15. PERSONAL DATA</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>16. INTEGRATION CLAUSE</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>17. DISPUTES</p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>18. FINAL PROVISIONS</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold'>19. CONTACT INFORMATION</p>
