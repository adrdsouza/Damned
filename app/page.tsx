...
export default async function Home() {
  return (
    <main className='flex flex-col'>
      ...
      <div className='flex'>
        <div
          className='text-white md:left-8 left-4 md:top-32 top-16 md:w-1/2 w-[350px]
        ...
        >
          ...
          <Link
            href='/shop'
            className='text-center px-10 py-4 border border-white rounded hover:border-slate'
          >
            SHOP NOW
          </Link>
        </div>
      ...
      <div className='md:relative bg-white'>
        <div className='sm:mt-0 lg:px-60 grid justify-items-center md:flex md:justify-around md:items-center'>
          <div className='sm:w-1/2'>
            <Image
              className='mt-[-10vh] xl:mt-[-20vh] w-[30vh] sm:w-[90vh]'
          ...
          <div className='w-1/2 py-2 px-10 xl:px-20 xl:py-5 lg:grid lg:grid-cols-1 lg:gap-5'>
            ...
            <Link
              ...
              className='lg:w-1/3 lg:py-2 border-2 border-black hover:bg-slate-100 group/button flex justify-center transition duration-300'
            >
