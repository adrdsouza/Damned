        ...
        <div className='flex m-auto px-8 w-full h-[400px] md:h-screen'>
          <div className='text-white my-auto text-center md:text-left'>
            ...
            <p className={`${text.md} mb-4`}>
              ...
              ourselves. After having them as a staple in our kitchen for the
              past six months and having run a sucessful Kickstarter campaign,
              our intention is is to now bring these remarkably designed,
              premium knives to your kitchen.
            </p>
            <p className={`${text.md} mb-4`}>
